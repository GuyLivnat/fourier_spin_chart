  ...
  return (
    <section className="row justify-content-center gx-0">
      <div className="col-lg-8 col-10">
        <h1 className="mb-5 mt-3"> Tutorial</h1>
        <div>
          <h2> The Visual </h2>
          <p>
            {" "}
        ...
        <div>
          <h2> The Fourier part</h2>
          <p>
            {" "}
            As you saw in the visual section, by adding different circles you
            can draw different shapes. Though getting a specific image by
            guessing which chain of circles would draw it is incredibly
            difficult, which is where Fourier transforms come in. <br />
            ...
            function, then express the series of sine waves as a chain of
            rotating circles.
            <br />
            Can you see where this is going? <br />
            Now we can take an image with a single line such as this one of
            Mushu from the film Mulan...
          </p>
          <MushuSVG size={150} />
          <br />
          apply that same Fourier Transform on it, and voilà! We have a series
          of circles that, when chained together, recreate the image over time.
          <TutorialChart
            coeff={{
              current: mushu.coeff,
            }}
